...
또 변수가 2개일때는 encoding, 즉 0과 1등의 숫자를 부여해서 마치 '1이 나올 확률'처럼 해석하는 시도가 어느정도 가능하지만(이때는 True, False의 역할을 하기 때문) 이 역시 아래 그림과 같이 회귀분석으로는 한계가 있다. 확률값으로 볼 수가 없음. (???뒤에서 나오는데 이는 LDA와 같다) (찾아보기!!!)

![class-linear](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\class-linear.PNG)
...
![class-linear-log](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\class-linear-log.PNG)
...
![logi-mle](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\logi-mle.PNG)
...
![logi-table](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\logi-table.PNG)
...
![stud-logi](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\stud-logi.PNG)
...
직접적으로 $$P(Y=k|X=x)$$를 구했던 로지스틱 회귀와는 조금 다르게, LDA에서는 조금 덜 직접적인 방법을 쓴다. 각각의 Y가 주어졌을때의 X의 분포, **즉 $$P(X|Y)$$를  통하여 _'Bayes' theorem'_으로 $$P(Y=k|X=x)$$를 추정하고자** 한다. 이 때 X의 분포,  $$P(X|Y)$$에 정규가정이 생긴다면, 로지스틱 회귀와 매우 유사한 형태가 된다.
...
![LDA1](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA1.PNG)
...
$$
![LDA2](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA2.PNG)
...
![LDA3](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA3.PNG)
...
![LDA4](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA4.PNG)
...
![LDA5](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA5.PNG)
...
![LDA-multi](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA-multi.PNG)
...
![LDA-multi2](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA-multi2.PNG)
...
![LDA-multi3](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA-multi3.PNG)
...
![LDA-multi4](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA-multi4.PNG)
...
![LDA-table](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA-table.PNG)
...
![LDA-table2](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA-table2.PNG)
...
![LDA6](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA6.PNG)
...
여러 threshold의 오류율을 비교하고자 할때, AUC(area under ROC curve)가 주로 이용된다. ![LDA7](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA7.PNG)
...
![LDA8](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA8.PNG)
...
![LDA9](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA9.PNG)
...
>
> ![LDA10](C:\Users\admin\내파일\3-2.5\스터디\ISL스터디\data\LDA10.PNG)
>
